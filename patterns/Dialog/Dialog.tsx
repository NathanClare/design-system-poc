        ...
        <Dialog.Content className="bg-primary-90 rounded-lg shadow-lg fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-9/12 max-w-md p-6 focus:outline-none">
          ...
          <div style={{ display: 'flex', marginTop: 25, justifyContent: 'flex-end' }}>
            <Dialog.Close asChild>
              <button className="inline-flex items-center justify-center rounded px-3.5 text-base font-medium h-9 bg-primary-80 text-primary-60 hover:bg-primary-70 focus:shadow-xl">
                Save changes
              </button>
            </Dialog.Close>
          </div>
          <Dialog.Close asChild>
            <button
              className="rounded-full h-6 w-6 inline-flex align-center justify-center text-primary-60 absolute top-5 right-3.5 focus:shadow-xl hover:shadow"
              aria-label="Close"
            >
              <Cross2Icon />
            </button>
