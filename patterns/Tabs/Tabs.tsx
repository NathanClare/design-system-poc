  ...
  return (
    <Tabs.Root className="flex flex-col shadow" style={{ width: 320 }} defaultValue="tab1">
      <Tabs.List className=" flex border-b-4 border-primary-50" aria-label="Manage your account">
        <Tabs.Trigger
          className="bg-primary-100 px-5 h-11 flex-1 flex items-center justify-center select-none text-neutral-70 data-[state=active]:text-primary-50 data-[state=active]:shadow first:rounded-tl-lg last:rounded-tr-lg hover:text-primary-70 focus:relative focus:shadow-lg"
          value="tab1"
        >
          Account
        </Tabs.Trigger>
