    ...
    <form>
      <RadixRadioGroup.Root className="flex flex-col gap-2.5" defaultValue="default" aria-label="View density">
        <div className={`flex items-center`}>
          <RadixRadioGroup.Item className="bg-neutral-white w-6 h-6 rounded-full shadow hover:bg-neutral-100 focus:shadow-xl" value="default" id="r1">
          ...
          <label className="pl-3.5 text-base select-none text-neutral-600" htmlFor="r1">
            Default
          </label>
        </div>
